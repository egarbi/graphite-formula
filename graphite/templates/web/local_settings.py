...
# to somewhere else
GRAPHITE_ROOT = '{{ graphite.install_path }}'

# Most installs done outside of a separate tree such as /opt/graphite will only
# need to change these three settings. Note that the default settings for each
# of these is relative to GRAPHITE_ROOT
CONF_DIR = '{{ graphite.install_path }}/conf'
STORAGE_DIR = '{{ graphite.install_path }}/storage'
CONTENT_DIR = '{{ graphite.install_path }}/webapp/content'
...
WHISPER_DIR = '{{ graphite.install_path }}/storage/whisper'
RRD_DIR = '{{ graphite.install_path }}/storage/rrd'
DATA_DIRS = [WHISPER_DIR, RRD_DIR] # Default: set from the above variables
LOG_DIR = '{{ graphite.install_path }}/storage/log/webapp'
INDEX_FILE = '{{ graphite.install_path }}/storage/index'  # Search index file
...
{%- for cache in graphite.caches %}
  #{{ carbonlink_hosts.append('"'+ '127.0.0.1:700' + loop.index|string + ':' + loop.index|string + '"') }}
{%- endfor %}
